package com.hengleasing.portal.scheduler.exceptions.configurations;
...
import com.hengleasing.portal.scheduler.utilities.EnvironmentUtil;
...
public class GlobalErrorAttributes extends DefaultErrorAttributes {
  ...
  public Map<String, Object> getErrorAttributes(WebRequest webRequest, ErrorAttributeOptions options) {
    ...
    GlobalResponseBody<Object> errorAttributes = GlobalResponseBody.<Object>builder()
        .respCode(respCode)
        .respMsg(environment.isDev() ? errorMsg : respMsg)
