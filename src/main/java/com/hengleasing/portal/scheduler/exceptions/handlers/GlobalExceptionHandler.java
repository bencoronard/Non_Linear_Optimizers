package com.hengleasing.portal.scheduler.exceptions.handlers;
...
import com.hengleasing.portal.scheduler.common.dtos.FieldValidationExceptionMap;
...
public class GlobalExceptionHandler {
  ...
  private static final Map<Class<? extends Throwable>, HttpStatus> EXCEPTION_STATUS_MAP = Map
      .of(ScheduleNotFoundException.class, HttpStatus.NOT_FOUND);
